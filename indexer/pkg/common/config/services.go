...
import "github.com/fystack/multichain-indexer/b2b-platform/pkg/common/enum"
...
type Services struct {
	...
	// MasterMnemonic is the BIP-39 seed phrase used for deterministic wallet
	// address derivation at business onboarding time. Load via env var
	// MASTER_MNEMONIC — never commit the real value to source control.
	MasterMnemonic string `yaml:"master_mnemonic"`
}
...
// MasterMnemonic is the BIP-39 mnemonic used for deterministic wallet derivation.
// Injected via MASTER_MNEMONIC env var. Never log or expose this value.
// This field is used by the onboarding service only — the indexer and dispatcher
