...
-- Create unique index on address + network
CREATE UNIQUE INDEX IF NOT EXISTS idx_unique_address_network ON wallet_addresses (address, type);

-- Create indexes for B2B queries
